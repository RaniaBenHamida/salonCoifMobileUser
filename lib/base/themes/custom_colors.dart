...
class CustomColor {
  //Light Color
  static Color primary = HexColor('#7A3DDD');
  static Color secondary = HexColor('#D860EC');
  ...
  //Dark Color
  static Color primaryDark = HexColor('#D99C2B');
  static Color secondaryDark = HexColor('#BF935E');
