  ...
  _buildDecoration() {
    return InputDecoration(
      hintText: widget.skipEnterText
          ? DynamicLanguage.isLoading ? "" : DynamicLanguage.key(widget.hintText)
          : "${DynamicLanguage.isLoading ? "" : DynamicLanguage.key(Strings.enter)} ${DynamicLanguage.isLoading ? "" : DynamicLanguage.key(widget.hintText)}",
